...
def load_data():
    ...
    df.columns = df.columns.str.strip()  # Eliminar espacios en blanco en los nombres de columnas
    return df
...
# Convertir las columnas de X a formato numérico (manejar errores)
...
best_trees = grid_search.best_estimator_  # Mejor estimador
y_pred = best_trees.predict(X_test)       # Predicciones
